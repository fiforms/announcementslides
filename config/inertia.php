    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // This application keeps its page components in resources/js/Pages
            // with a capital P, which was inertia-laravel v2's default. v3
            // changed the default to a lowercase js/pages, so without this
            // every assertInertia() fails with "page component file [...] does
            // not exist" -- the view finder looks in a directory that does not
            // exist here. Set explicitly rather than renaming 35 components
            // and the @vite() entry that resolves them.
